...
<head>
    <meta charset="utf-8">
    <title>enPunto - Recuperación de Contraseña</title>
    ...
    <link rel="mask-icon" href="img/splash/safari-pinned-tab.svg" color="#5bbad5">
    <meta name="msapplication-TileColor" content="#da532c">
    <meta name="msapplication-TileImage" content="img/splash/mstile-144x144.png">
...
<header id="header">
    ...
    <div id="logo-group">
        <span id="logo"> <img src="img/logo_flat.png" alt="enPunto"> </span>
    </div>
        ...
        <div class="row centered">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 center-block" style="float:none;">
                ...
                <div class="well no-padding">
                    ...
                    <form action="password.php" id="password-form" class="smart-form client-form" method="post">
                        <header>
                            <?php echo _("Nueva contraseña"); ?>
                        </header>
                        <?php if ($T_Token == '' && $mensaje == '') { ?>
                            <fieldset>
                                <?php if ($T_Error) echo "<div class=\"alert alert-danger fade in\"><strong>Error!</strong>&nbsp;&nbsp;" . $T_Error . "</div>"; ?>
                                <section>
                                    <label class="label"><?php echo _("Email"); ?></label>
                                    <label class="input"> <i class="icon-append fa fa-user"></i>
                                        <input type="email" name="email">
                                        <b class="tooltip tooltip-top-right"><i
                                                class="fa fa-user txt-color-teal"></i> <?php echo ' ' . _('Por favor, ingrese su email') ?>
                                        </b></label>
                                </section>
                                <section>
                                    <div class="note">
                                        Ingrese su email, si existe en la base de datos, recibirá un correo con
                                        instrucciones para resetear su contraseña
                                    </div>
                                </section>
                            </fieldset>
                        <?php } else if ($T_Token != '' && $mensaje == '') { ?>
                            <fieldset>
                                <?php if ($T_Error) echo "<div class=\"alert alert-danger fade in\"><strong>Error!</strong>&nbsp;&nbsp;" . $T_Error . "</div>"; ?>
                                <section>
                                    <label class="input"> <i class="icon-prepend fa fa-key"></i>
                                        <input name="clave" id="clave" class="form-control" placeholder="Contraseaña"
                                               type="password">
                                    </label>
                                </section>
                                <section>
                                    <label class="input"> <i class="icon-prepend fa fa-key"></i>
                                        <input name="re_clave" class="form-control" placeholder="Repita la Contraseña"
                                               type="password">
                                    </label>
                                </section>
                                <input type="hidden" name="t" value="<?php echo htmlspecialchars($T_Token) ?>"/>
                            </fieldset>
                        ...
                        <footer>
                            <?php if ($mensaje == '') { ?>
                                <button type="submit" class="btn btn-primary" name="btnReset">
                                    <?php
                                    if ($T_Token == '' && $mensaje == '') {
                                        echo _('Enviar');
                                    } else if ($T_Token != '' && $mensaje == '') {
                                        echo _('Guardar');
                                    }
                                    ?>
                                </button>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#password-form").validate({
            ...
            messages: {
                email: {
                    required: '<?php echo _('Por favor, ingrese su email') ?>',
                    type: '<?php echo _('El email no es válido') ?>'
                },
                clave: {
