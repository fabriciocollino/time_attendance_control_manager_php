    ...
    <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-50" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" > 
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                <form class="smart-form" novalidate="novalidate" data-async="" method="post" id="filtro-form" action="<?php echo $Filtro_Form_Action; ?>"> 
                    <fieldset>
                        <div class="row">	
                                ...
                                <section class="col col-2"  style="min-width: 195px;">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control " style="padding-left: 5px;font-size: 12px;height: 31px;" name="fechaD" id="fechaD" type="text" placeholder="Desde" value="<?php echo $_SESSION['filtro']['fechaD']; ?>">
                                            <span class="input-group-addon"><i class="fa fa-calendar" style="line-height: 19px!important;padding-left: 5px;"></i></span>
                                        </div>
                                    </div>
                                </section>
                                <section class="col col-2"  style="min-width: 195px;">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control " style="padding-left: 5px;font-size: 12px;height: 31px;" name="fechaH" id="fechaH" type="text" placeholder="Hasta" value="<?php echo $_SESSION['filtro']['fechaH']; ?>">
                                            <span class="input-group-addon"><i class="fa fa-calendar" style="line-height: 19px!important;padding-left: 5px;"></i></span>
                                        </div>
                                    </div>											
                                </section>
